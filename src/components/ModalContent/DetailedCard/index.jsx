...
import { compileDetails, compileFeatures, formatPrice } from 'services/helpers';
import BookingForm from 'components/ModalContent/BookingForm';

const DetailedCard = ({ card, isDescriptionHidden, setDecriptionState }) => {
    ...
    <section className={styles.modalContent}>
      ...
      <div className={styles.descriptionBar}>
        ...
        <button onClick={handleReadMore} className={styles.buttonMore}>
          {isDescriptionHidden ? 'Read less' : 'Read more'}
        </button>
      </div>
